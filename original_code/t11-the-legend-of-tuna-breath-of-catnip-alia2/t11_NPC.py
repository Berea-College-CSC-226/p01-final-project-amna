...
class fish(pygame.sprite.Sprite):
    def __init__(self, screen_size):
        super().__init__()
        self.surf = pygame.image.load('images/fish.jpg').convert_alpha()
        self.surf = pygame.transform.scale(self.surf, (40, 40))

        # Random appear anywhere on screen
        self.rect = self.surf.get_rect(
            center=(random.randint(50, screen_size[0]-50),
                    random.randint(50, screen_size[1]-50))
        )

    def respawn(self, screen_size):
        """
        Move catnip to a new random location when it respawns
        """
        self.rect.center = (
