...
import pygame
from t11_NPC import NPC, Good_NPC, Bad_NPC,fish
...
class Game:
    ...
    def run(self):
        ...
        while self.running:
            ...
            # Check if player touches catnip
            if pygame.sprite.collide_rect(self.tuna, self.fish):
                self.tuna.speed += 2  # increase player speed
                self.fish.respawn(self.size)
